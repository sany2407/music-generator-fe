  ...
  return (
    <div className="glass animate-fade-up w-full max-w-md rounded-[2rem] p-9 md:p-11">
      <h1 className="font-display text-3xl font-bold">
        Join the <span className="text-gradient">studio.</span>
      </h1>
      <p className="mt-2 text-sm text-white/45">
        One account. Infinite soundtracks.
      </p>
      ...
      >
        ...
        <label className="block">
          ...
          <input
            ...
            className="w-full rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm outline-none transition placeholder:text-white/25 focus:border-neon-cyan/60 focus:shadow-[0_0_24px_rgba(34,211,238,0.2)]"
          />
        </label>
